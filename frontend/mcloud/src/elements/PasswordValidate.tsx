...
export const PasswordInput: React.FC<{password: string,
    setPassword: (password: string) => void, confirm: boolean}> = ({ password, setPassword, confirm }) => {

    return (
        <>
            <label htmlFor={confirm ? 'password' : 'confirmPassword'}>{confirm ? 'Пароль:' :
...
export const PasswordValidation: React.FC<{password: string,
    setPassword: (password: string) => void, confirm: boolean,
