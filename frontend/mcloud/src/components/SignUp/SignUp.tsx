            ...
            <form method="post" onSubmit={handleRegistration}>
                ...
                <div className="form-group">
                    <PasswordValidation password={password} setPassword={setPassword}
                                        confirm={true} setIsDisabled={setIsDisabled}/>
                </div>
                <div className="form-group">
                    <PasswordValidation password={confirmPassword}
                                        setPassword={setConfirmPassword}
                                        confirm={false} setIsDisabled={setIsDisabled}/>
                </div>
                <button type='submit' className='button-submit' disabled={isDisabled}>Зарегистрироваться</button>
