...
import type {FileRenameProps} from '../../../models';
import { useSelector } from 'react-redux';
import type {RootState} from '../../../store';


const FileRename: React.FC<FileRenameProps> = ({ currentFile,
                                                   setForm,
                                                   setCurrentFile,
                                                   setFiles }) => {
    ...
    const [currentStorageUser, setCurrentStorageUser] = useState<number>(userId || 0); // Устанавливаем
