...
2. В файле [api.ts](/frontend/mcloud/src/api/api.ts) поменять параметр BASE_URL в зависимости от вашего сервера. У меня на сервере будет: export const BASE_URL = 'http://91.197.97.46/api';